...
import { fetchCollectionDetails } from '../../redux/routines';
...
class Collection extends Component<IProps> {
	componentDidMount() {
		this.props.fetchCollectionDetails({
			movieListId: this.props.navigation.state.params.id
		});
	}
	render() {
		...
		return (
						...
						<View style={styles.background}>
							<View style={styles.horizontalContainer}>
								<Image
									...
									style={styles.avatar}
								/>
								<Text style={[styles.collectionText, styles.imageText]}>
									{user.name}
								</Text>
								<Text
									style={[
							...
							<Text style={[styles.imageText, styles.collectionTitle]}>
								{title}
							</Text>
						</View>
					</ImageBackground>
			...
			>
				<Text style={[styles.collectionText, styles.description]}>
					{description}
				</Text>
				{movies.map((movie, i) => (
					<TouchableWithoutFeedback>
